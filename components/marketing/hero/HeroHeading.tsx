...
function HeroHeading() {
  return (
    ...
    <h1 className="title text-[64px] font-bold leading-[1.2] tracking-[-0.02em] text-foreground mb-6">
         Design websites 
    ...
    <p className="subtitle text-[18px] text-muted-foreground leading-[1.6] max-w-160 mb-9">
